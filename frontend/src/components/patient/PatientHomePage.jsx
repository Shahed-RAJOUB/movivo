  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <p className="text-lg text-gray-700">
        Nutze die Navigation links, um durch die verschiedenen Bereiche zu wechseln. Dein aktueller Fortschritt und deine Termine werden hier bald verfügbar sein!
      </p>
    </div>
  );
} 